import type { ArsenalSkill } from "@/app/lib/types";

export const ARSENAL_TOTAL = 344;
export const ARSENAL_BUNDLE_MB = "12.1";
export const ARSENAL_CATEGORIES: { name: string; count: number }[] = [
  {
...
export const ARSENAL_SKILLS: ArsenalSkill[] = [
  ...
  {
    "id": "global-claude-md-setup",
    "name": "global-claude-md-setup",
    "description": "Generate a personalized ~/.claude/CLAUDE.md identity file for a user, or render the printable PDF guide that explains the full Identity Layer framework. TRIGGER on phrases like \"set up global CLAUDE.md\", \"generate my global claude file\", \"personalize ~/.claude/CLAUDE.md\", \"claude md template\", \"identity layer setup\", or \"give me the CLAUDE.md guide pdf\". Asks structured questions, writes the file to disk, and optionally rebuilds the branded PDF handout.",
    "category": "AI Agents",
    "hasBundle": true
  },
  {
  ...
  },
  {
    ...
    "description": "Behavioral guidelines to reduce common LLM coding mistakes, derived from Andrej Karpathy's observations on AI-assisted development pitfalls",
    "category": "AI Agents",
    "hasBundle": false
  },
  {
  ...
  },
  {
    "id": "bo-designs",
    "name": "bo-designs",
    "description": "> Website template builder that takes full-page website screenshots and rebuilds them as annotated wireframe HTML templates, or generates real websites from templates using user content. Use when the user says \"build a template from this screenshot\", \"analyze this website\", \"recreate this layout\", \"make a wireframe from this page\", \"use BO designs\", \"copy this website layout\", \"rebuild this site\", \"bo designs\", or provides a full-page website screenshot to replicate. Also use when the user wants to generate a real website from an existing wireframe template structure with their own content.",
    "category": "Frontend",
    "hasBundle": true
  },
  {
  ...
  },
  {
    "id": "ghl-builder",
    "name": "ghl-builder",
    "description": "| GHL internal backend API skill. TRIGGER when: (1) User pastes JSON with \"tokenId\" key (from GHL Key Grabber Chrome extension) (2) User pastes a Firebase refresh token starting with \"AMf-\" (3) User mentions GHL, GoHighLevel, HighLevel, sub-account, or white-label in context of backend operations (4) User asks to read/list/create/copy/migrate custom fields, pipelines, workflows, smart tags, WhatsApp templates, or custom values This skill covers ALL operations on backend.leadconnectorhq.com and services.leadconnectorhq.com.",
    "category": "Backend",
    "hasBundle": true
  },
  {
  ...
  },
  {
    ...
    "description": "Editorial minimalism mode - warm monochrome, typographic hierarchy, Notion/Linear/Vercel aesthetic. Color as scarce resource. No decoration for decoration's sake.",
    "category": "Backend",
    "hasBundle": false
  },
  {
  ...
  },
  {
    ...
    "description": "Image-first design workflow - generate visual design comps first, analyze them deeply, then implement faithfully. Prevents design drift and generic output.",
    "category": "Design & Content",
    "hasBundle": false
  },
  {
    "id": "redesign-skill",
    "name": "redesign-skill",
    "description": "Structured audit-and-upgrade framework for improving existing UIs without rewriting. Scan → Diagnose → Fix in priority order.",
    "category": "Design & Content",
    "hasBundle": false
  },
  {
  ...
  },
  {
    "id": "soft-skill",
    "name": "soft-skill",
    "description": "Awwwards-tier premium UI mode - haptic depth, spatial rhythm, spring physics, and bespoke component patterns. For when polish is the entire point.",
    "category": "Other",
    "hasBundle": false
  },
  {
    "id": "taste-skill",
    "name": "taste-skill",
    "description": "Premium UI engineering framework - anti-slop design system with tunable design parameters, motion standards, and layout rules for award-quality interfaces",
    "category": "Other",
    "hasBundle": false
  }
];
